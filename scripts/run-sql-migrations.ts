...
const ALL_FILES = [
  ...
  "031_people_core.sql",
  "032_people_supporting.sql",
  "033_people_identity_resolution.sql",
  "034_workflows_people_link.sql",
  "035_kpi_spine.sql",
  "036_compliance_core.sql",
  "037_comms_core.sql",
  "038_comms_compliance_fk.sql",
  "039_compliance_message_log_indexes.sql",
  "040_kpi_intel_scale.sql",
  "041_messaging_orchestration.sql",
  "042_messaging_engagement_branching.sql",
  "043_deliverability_threshold_configs.sql",
